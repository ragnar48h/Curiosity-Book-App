...
import { ChildrenWithProps, EvaInputSize, EvaStatus, IndexPath, RenderProp, TouchableWebProps } from '../../devsupport';
 ...
 */
export declare class SelectComponent extends React.Component<SelectProps, State> {

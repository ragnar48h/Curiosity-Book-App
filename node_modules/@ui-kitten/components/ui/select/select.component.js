 ...
 */
class SelectComponent extends react_1.default.Component {
    constructor() {
        super(...arguments);
        this.state = {
            listVisible: false,
        ...
        this.renderDefaultIconElement = (evaStyle) => {
            return (react_1.default.createElement(react_native_1.Animated.View, { style: { transform: [{ rotate: this.expandToRotateInterpolation }] } },
                react_1.default.createElement(chevronDown_component_1.ChevronDown, Object.assign({}, evaStyle, { fill: evaStyle.tintColor }))));
        };
...
exports.Select = theme_1.styled(SelectComponent);

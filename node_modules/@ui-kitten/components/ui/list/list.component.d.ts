 ...
 */
export declare class ListComponent<ItemT = any> extends React.Component<ListProps> {
...
export declare const List: import("../../theme").StyledComponentClass<ListProps<any>>;
export {};

...
export declare class MenuService {
    ...
    createDescriptorForNestedElement: (element: React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>, groupDescriptor: MenuItemDescriptor, index: number) => MenuItemDescriptor;
}

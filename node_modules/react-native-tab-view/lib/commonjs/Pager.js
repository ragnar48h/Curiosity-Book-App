...
class Pager extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "gestureHandlerRef", React.createRef());
    ...
    _defineProperty(this, "transitionTo", index => {
      ...
      [cond(not(clockRunning(this.clock)), _reactNative.I18nManager.isRTL ? set(this.initialVelocityForSpring, multiply(-1, this.velocityX, this.springVelocityScale)) : set(this.initialVelocityForSpring, multiply(this.velocityX, this.springVelocityScale))), spring(this.clock, _objectSpread({}, state, {
        velocity: this.initialVelocityForSpring
      }), _objectSpread({}, SPRING_CONFIG, {}, this.springConfig, {
        toValue
      }))], // Otherwise use a timing animation for faster switching
      timing(this.clock, _objectSpread({}, state, {
        frameTime
      }), _objectSpread({}, TIMING_CONFIG, {}, this.timingConfig, {
        toValue

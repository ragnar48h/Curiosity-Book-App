  ...
  render() {
    ...
    return children({
      ...
      render: children => /*#__PURE__*/React.createElement(Animated.ScrollView, {
        ...
        exec: onChange(this.relativePosition, cond(eq(round(this.relativePosition), this.relativePosition), [call([this.relativePosition], ([relativePosition]) => onIndexChange(relativePosition))]))
      }))
    });
  }

...
export default class Pager extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "transitionTo", index => {
      ...
      [cond(not(clockRunning(this.clock)), I18nManager.isRTL ? set(this.initialVelocityForSpring, multiply(-1, this.velocityX, this.springVelocityScale)) : set(this.initialVelocityForSpring, multiply(this.velocityX, this.springVelocityScale))), spring(this.clock, _objectSpread({}, state, {
